...
const MERMAID_ENCYCLOPEDIA_DESCRIPTIONS = {
  ...
  farm:
    "{name}은 청회 개복치 몸에 노인 얼굴이 붙은 채 심해를 천천히 가라앉아요. 등·복·꼬리 지느러미까지 다 보이지만, 대부분은 얼굴만 본다고 합니다. 가만히 있다가 눈만 꽉 감았다 뜨는데, {name}은 '큰 것만 움직이면 바닷물이 흔들린다'며 조심한다고 해요. 실제로 흔들린 적은 없습니다. 인면어 이야기를 들으면 '잉어 쪽 친척'이라고만 짧게 답해요.",
  plain:
