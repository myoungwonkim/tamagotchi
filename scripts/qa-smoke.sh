...
test -f privacy.html && ok 'privacy.html (root)' || bad 'privacy.html (root)'
test -f terms-of-service.html && ok 'terms-of-service.html (root)' || bad 'terms-of-service.html (root)'
test -f CNAME && ok 'CNAME' || bad 'CNAME'
