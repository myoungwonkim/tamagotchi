...
## H. 앱인토스 광고 (`?toss=1&mockAds=1` 또는 샌드박스)

| #   | 시나리오 | 기대 결과 | Pass |
| --- | -------- | --------- | ---- |
| H1  | 게임오버 → 새 펫 | T1 전면형(또는 모의) 후 이름 모달 | [ ] |
| H2  | 게임오버 → 광고 보고 부활 | R1 후 펫 복원 | [ ] |
| H3  | 스탯 위험 → 응급 돌봄 | R2 보상형 | [ ] |
| H4  | 방치 임박 → 타이머 초기화 | R3 보상형 | [ ] |
| H5  | 성체 진화 | T2 전면형 (세션 1회) | [ ] |
| H6  | 졸업 → 새 알 | T3 전면형 | [ ] |
| H7  | 30분+ 오프라인 복귀 | T4 전면형 (세션 1회) | [ ] |

상세: **[APPS-IN-TOSS-LAUNCH.md](APPS-IN-TOSS-LAUNCH.md)** · **[MONETIZATION.md](MONETIZATION.md)**
